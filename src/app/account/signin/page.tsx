        ...
        >
          ...
          <label className="flex flex-col gap-2 text-sm">
            ...
            <input
              ...
              className="rounded-xl bg-white/5 border border-white/10 px-4 py-3 text-white text-sm outline-none focus:border-violet-500/60 focus:bg-white/8 transition-colors placeholder-white/20"
